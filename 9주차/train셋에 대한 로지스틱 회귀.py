...
w0_history, w1_history, w2_history, cee_history, accuracy_history = gradient_descent(train_x_with_dummy, train_y, 0.3, 4000)
...
plt.xlabel('Iterations')
plt.ylabel('Accuracy')
plt.title('Accuracy over Iterations (Training Data)')
plt.grid()
plt.show()
