...
plt.scatter(train_set[train_set[:, 2] == 0, 0], train_set[train_set[:, 2] == 0, 1], color='blue', marker='o', label='Train Class 0')
plt.scatter(train_set[train_set[:, 2] == 1, 0], train_set[train_set[:, 2] == 1, 1], color='red', marker='o', label='Train Class 1')
...
plt.figure(figsize=(8, 6))
# 클래스 0과 클래스 1을 다른 색상으로 표시
plt.scatter(test_set[test_set[:, 2] == 0, 0], test_set[test_set[:, 2] == 0, 1], color='blue', marker='o', label='Test Class 0')
plt.scatter(test_set[test_set[:, 2] == 1, 0], test_set[test_set[:, 2] == 1, 1], color='red', marker='o', label='Test Class 1')
plt.plot(x_values, y_values, color='black', label='Decision Boundary')
plt.xlabel('Attendance rate[%]')
plt.ylabel('Exam score')
